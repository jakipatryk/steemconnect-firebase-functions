 ...
 */
exports.isAccessTokenInvalidError = ({ error, error_description }) => checkOAuth2Error_1.checkOAuth2Error({ error, error_description }, ACCESS_TOKEN_INVALID_1.ACCESS_TOKEN_INVALID);
