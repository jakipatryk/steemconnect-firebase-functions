 ...
 */
export declare function createComment(parentPermlink: string, author: string, permlink: string, body: string, parentAuthor?: string, title?: string, jsonMetadata?: object): Operation;
