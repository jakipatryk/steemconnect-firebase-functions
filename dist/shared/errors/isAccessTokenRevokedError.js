 ...
 */
exports.isAccessTokenRevokedError = ({ error, error_description }) => checkOAuth2Error_1.checkOAuth2Error({ error, error_description }, constants_1.ACCESS_TOKEN_REVOKED);
