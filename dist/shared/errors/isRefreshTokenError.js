 ...
 */
exports.isRefreshTokenError = function (_a) {
    var error = _a.error, error_description = _a.error_description;
    return checkOAuth2Error_1.checkOAuth2Error({ error: error, error_description: error_description }, constants_1.REFRESH_TOKEN_INVALID);
};
