...
describe('getAuthorizationUrl', () => {
    ...
    it('should return a correct url when scope has one element', () => {
        ...
        expect(authorizationUrl).to.equal('https://steemconnect.com/oauth2/authorize?client_id=test.app&response_type=code&redirect_uri=https%3A%2F%2Fwykop.pl%2Fredirect&scope=vote');
    });
    ...
    it('should return a correct url when scope has more than one element', () => {
        ...
        expect(authorizationUrl).to.equal('https://steemconnect.com/oauth2/authorize?client_id=test.app&response_type=code&redirect_uri=https%3A%2F%2Fadam.malysz%2Fredirect&scope=vote%2Ccomment');
    });
