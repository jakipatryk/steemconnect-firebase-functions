import { broadcastDownvote } from '../../src/broadcasting/broadcastDownvote';
...
describe('broadcastDownvote', function() {
  ...
  it('should broadcast downvote and return result', async function() {
    ...
    const broadcastResult = await broadcastDownvote(voteConfig)(accessToken);
